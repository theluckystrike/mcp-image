...
test.skip("an upscale says the pixels were interpolated", async () => {
...
test.skip("watermark text: newline, transliteration, unrenderable text and overflow", async () => {
...
test.skip("dominant colours name a photograph as having no palette", async () => {
...
test.skip("every input is sha256-identical after a full pass of the write tools", async () => {
...
test.skip("the free tier names three dominant colours rather than refusing", async () => {
