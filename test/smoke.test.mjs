...
test.skip("free tier: a six-file batch is refused with the checkout URL, Pro runs it", async () => {
...
test.skip("free tier caps the OUTPUT, not the source: a 4.4 MP photo resized small is free", async () => {
